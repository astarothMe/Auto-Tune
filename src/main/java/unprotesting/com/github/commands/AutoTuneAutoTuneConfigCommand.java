...
public class AutoTuneAutoTuneConfigCommand implements CommandExecutor {
    ...
    public static final List<Player> pList = new ArrayList<>();

    @Override
    public boolean onCommand(@NotNull CommandSender sender, Command command, @NotNull String atconfig, @NotNull String[] args) {
    ...
    public ItemStack createOtherSettings(){
        ItemStack is = new ItemStack(Objects.requireNonNull(Material.matchMaterial("STONE")));
        ItemMeta im = is.getItemMeta();
        Objects.requireNonNull(im).setDisplayName(ChatColor.GREEN + "Other Settings");
        im.setLore(Collections.singletonList(ChatColor.WHITE + "Click to Change Settings"));
        is.setItemMeta(im);
        return is;
    }

    public ItemStack createOtherEcononomySettings(){
        ItemStack is = new ItemStack(Objects.requireNonNull(Material.matchMaterial("GOLD_INGOT")));
        ItemMeta im = is.getItemMeta();
        Objects.requireNonNull(im).setDisplayName(ChatColor.GREEN + "Other Econonomy Settings");
        im.setLore(Collections.singletonList(ChatColor.WHITE + "Click to Change Settings"));
        is.setItemMeta(im);
        return is;
    }
    ...
    public ItemStack createExponentialPricingModelSetting(){
        ItemStack is = new ItemStack(Objects.requireNonNull(Material.matchMaterial("Piston")));
        ItemMeta im = is.getItemMeta();
        Objects.requireNonNull(im).setDisplayName(ChatColor.GREEN + "Exponential Pricing-Model Settings");
        im.setLore(Collections.singletonList(ChatColor.WHITE + "Click to Change Settings"));
        is.setItemMeta(im);
        return is;
    }
    ...
    public ItemStack createBasicAdvancedPricingModelSetting(){
        ItemStack is = new ItemStack(Objects.requireNonNull(Material.matchMaterial("REDSTONE")));
        ItemMeta im = is.getItemMeta();
        Objects.requireNonNull(im).setDisplayName(ChatColor.GREEN + "Basic/Advanced Pricing-Model Settings");
        im.setLore(Collections.singletonList(ChatColor.WHITE + "Click to Change Settings"));
        is.setItemMeta(im);
        return is;
    }
    ...
    public ItemStack createGeneralSetting(){
        ItemStack is = new ItemStack(Objects.requireNonNull(Material.matchMaterial("GRASS_BLOCK")));
        ItemMeta im = is.getItemMeta();
        Objects.requireNonNull(im).setDisplayName(ChatColor.GREEN + "General Settings");
        im.setLore(Collections.singletonList(ChatColor.WHITE + "Click to Change Settings"));
        is.setItemMeta(im);
        return is;
    }
    ...
    public ItemStack createItemStackWithMeta(String setting, int configSetting){
        return createItemStackWithMeta(setting, String.valueOf(configSetting));
    }

    public ItemStack createItemStackWithMeta(String setting, String configSetting){
        ItemStack is = new ItemStack(Objects.requireNonNull(Material.matchMaterial("LEVER")));
        ItemMeta im = is.getItemMeta();
        Objects.requireNonNull(im).setDisplayName(ChatColor.GREEN + setting + " : " + configSetting);
