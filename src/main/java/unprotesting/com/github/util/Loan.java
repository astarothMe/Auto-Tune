...
public class Loan implements Serializable{
    ...
    public final double interest_rate_update;
    ...
    public void inputLoanToMap(Loan loan, Player player){
        ...
        player.sendMessage(ChatColor.YELLOW + "New Loan Created! This is your " + ChatColor.GREEN +  MathHandler.ordinal(Objects.requireNonNull(mainLoans).size()+1) + " loan");
